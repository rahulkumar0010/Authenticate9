...
export const ThreeDotIcon: React.FC<SVGIconProps> = ({
  className,
  size = 16,
  color = "currentColor",
}) => {
...
export const AddWatchListIcon: React.FC<SVGIconProps> = ({
  className,
  size = 28.673,
  color = "currentColor",
}) => {
  return (
    ...
    >
      <g>
        <g id="c2_ribbon">
          <path
            d="M21.385,0H7.289c-0.232,0-0.42,0.189-0.42,0.417v27.84c0,0.168,0.1,0.318,0.26,0.384
